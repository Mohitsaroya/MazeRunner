/*********************************
* @File level2.c
* @Brief Definition of the function of level2.h
* @Author Evan Wong
* @Date dec.4,2025
********************************/
#include <ncurses.h>
...
int level2Phase(void) {
    ...
    level2Card(level2Win);// calls for the level 2 splash screen
    getch();
    delwin(level2Win);

    refresh();

    int res = second_level_maze();// this calls second_leveelmaze() to make the game
